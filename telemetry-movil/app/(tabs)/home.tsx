...
// HomeScreen is the monitoring/simulation screen shown in the Home tab.
// It assumes an active vehicle exists (the tab navigator is only shown when
// one is in the store). If the vehicle is cleared unexpectedly, it renders
// nothing to avoid crashes.
export default function HomeScreen() {
  ...
  // Safety: if no active vehicle, redirect to setup.
