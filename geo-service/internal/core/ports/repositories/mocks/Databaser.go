...
func (_m *Databaser) BeginTx(ctx context.Context, opts *sql.TxOptions) (*sql.Tx, error) {
...
func (_m *Databaser) ExecContext(ctx context.Context, query string, args ...interface{}) (sql.Result, error) {
	var _ca []interface{}
...
func (_m *Databaser) PingContext(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *Databaser) QueryContext(ctx context.Context, query string, args ...interface{}) (*sql.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *Databaser) QueryRowContext(ctx context.Context, query string, args ...interface{}) *sql.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
